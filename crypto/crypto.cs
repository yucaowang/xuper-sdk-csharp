...
namespace XChainSDK
{
    ...
    class XCrypto
    {
        // SignHash sign data using given private key and return ASN.1 DER encoded signature
        ...
        // VerifySign verify ASN.1 DER encoded signature using given public key with data
        ...
        public static byte[] Asn1EncodeSign(byte[] r, byte[] s)
        {
        ...
        public static byte[] Asn1EncodeSign(BigInteger r, BigInteger s)
        {
        ...
        public static byte[] Asn1DecodeSign(byte[] sign)
        {
            if (sign.Length <= 8)
            {
                throw new System.ArgumentException();
